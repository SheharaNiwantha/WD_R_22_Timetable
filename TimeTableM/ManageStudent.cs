...
namespace TimeTableM
{
    public partial class ManageStudent : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qu = "SELECT `AcademicSemYear`,`Programme`, `GrpNo`, `SubGrpNum`, `GrpID`, `SubGrpID` FROM `addstudentgrp` WHERE SubGrpID = '" + txtStdSearch.Text + "'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qu = "DELETE FROM `addstudentgrp` WHERE SubGrpID = '" + txtSubGrpID.Text + "'";
                MySqlCommand cm = new MySqlCommand(qu, con);
                cm.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qu = "UPDATE `addstudentgrp` SET `AcademicSemYear`='" + cmbAcademicSemYear.Text + "',`GrpNo`='" + cmbGrpNo.Text + "',`SubGrpNum`='" + cmbSubGrpNum.Text + "',`GrpID`='" + txtGrpID.Text + "',`SubGrpID`='" + txtSubGrpID.Text + "' WHERE SubGrpID = '" + txtSubGrpID.Text + "'";
                MySqlCommand cm = new MySqlCommand(qu, con);
                cm.ExecuteNonQuery();

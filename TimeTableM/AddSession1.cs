...
namespace TimeTableM
{
    public partial class AddSession1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qu = "INSERT INTO addSesstion (`Fac`, `department`,`firstLec`, `secondLec`, `tag`, `tagType`, `grp`, `subject`, `noOfStd`, `day`, `room`, `time`, `AllDetails`) VALUES ('" + cmbFaculty.Text + "','" + cmbDepartment.Text + "','" + cmb1Lec.Text + "','" + cmb2Lec.Text + "','" + cmbTimeSlot.Text + "','" + txtShowTag.Text + "','" + cmbGrp.Text + "','" + comboBox3.Text + "','" + txtNoOfStd.Text + "','" + cmbDay.Text + "','NULL','" + cmbTime.Text + "','" + lblAllDetails.Text + "')";

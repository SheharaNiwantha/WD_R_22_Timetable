...
namespace TimeTableM
{
    public partial class SessionDash : Form
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qu = "SELECT * FROM `addsesstion` WHERE day = '" + cmbDayLoc.Text + "' AND time = '" + cmbTime.Text + "' AND `department` = '" + cmbDepartment.Text + "'";
                MySqlCommand cm = new MySqlCommand(qu, con);
                MySqlDataAdapter da = new MySqlDataAdapter(cm);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qu = "SELECT `department`,`firstLec`,`secondLec`,`subject`,`room` FROM `addsesstion`";
                MySqlCommand cm = new MySqlCommand(qu, con);
                MySqlDataAdapter da = new MySqlDataAdapter(cm);
